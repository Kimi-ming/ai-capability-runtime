...
- 文档维护规则：`docs/社区/documentation-governance.md`
...
- V1 详细需求：`docs/规划/v1-requirements.md`
- V1 详细架构：`docs/规划/v1-architecture.md`
- 技术方案审查：`docs/评审/technical-plan-review-2026-05-07.md`
