...
- [执行语义 V1](docs/design/execution-semantics-v1.md)
- [重试与幂等 V1](docs/design/retry-and-idempotency-v1.md)
- [失败恢复手册](docs/operations/failure-recovery-runbook.md)
- [执行证据 V1](docs/quality/execution-evidence-v1.md)
- [组合边界 V1](docs/design/composition-boundary-v1.md)
- [能力图 V1](docs/ecosystem/capability-graph-v1.md)
- [多步执行边界](docs/design/multi-step-execution-boundary.md)
- [组合失败恢复](docs/operations/composition-failure-runbook.md)
- [Trust 模型 V1](docs/ecosystem/trust-model-v1.md)
- [Capability 安全公告流程](docs/security/capability-advisory-process.md)
- [能力弃用与撤销](docs/ecosystem/capability-deprecation-and-revocation.md)
- [能力质量评分](docs/quality/capability-quality-score.md)
- [用量计量 V1](docs/operations/usage-metering-v1.md)
- [配额与预算策略](docs/design/quota-and-budget-policy-v1.md)
- [限流与滥用控制](docs/security/rate-limit-and-abuse-control-v1.md)
- [付费能力与商业边界](docs/ecosystem/paid-capability-and-commerce-boundary.md)
- [用量证据 V1](docs/quality/usage-evidence-v1.md)
- [Tool Projection V1](docs/design/tool-projection-v1.md)
- [Prompt Surface Security V1](docs/security/prompt-surface-security-v1.md)
- [能力发现与选择边界](docs/ecosystem/discovery-and-selection-boundary.md)
- [模型可见元数据 Lint](docs/quality/model-visible-metadata-lint-v1.md)
- [Result Envelope V1](docs/design/result-envelope-v1.md)
- [Output Validation V1](docs/quality/output-validation-v1.md)
- [Tool Result Sanitization V1](docs/security/tool-result-sanitization-v1.md)
- [Result Provenance V1](docs/quality/result-provenance-v1.md)
- [结果投递边界](docs/ecosystem/result-delivery-boundary.md)
- [Input Data Governance V1](docs/security/input-data-governance-v1.md)
- [Data Classification V1](docs/security/data-classification-v1.md)
- [Data Egress Policy V1](docs/design/data-egress-policy-v1.md)
- [Policy Decision Trace V1](docs/design/policy-decision-trace-v1.md)
- [Policy 生命周期与变更控制](docs/operations/policy-lifecycle-and-change-control.md)
- [Policy Simulation and Diff V1](docs/quality/policy-simulation-and-diff-v1.md)
- [Policy Override and Breakglass V1](docs/security/policy-override-and-breakglass-v1.md)
- [Input Provenance V1](docs/quality/input-provenance-v1.md)
- [数据最小化与脱敏 V1](docs/security/data-minimization-and-redaction-v1.md)
