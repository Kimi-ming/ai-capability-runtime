...
- GitHub private vulnerability reporting: https://docs.github.com/en/code-安全/security-advisories/guidance-on-reporting-and-writing-information-about-vulnerabilities/privately-reporting-a-security-vulnerability
- GitHub configuring private vulnerability reporting: https://docs.github.com/en/code-安全/security-advisories/working-with-repository-security-advisories/configuring-private-vulnerability-reporting-for-a-repository
- OpenSSF Scorecard: https://openssf.org/projects/scorecard/
- OSV schema: https://ossf.github.io/osv-schema/
- OpenVEX: https://openssf.org/projects/openvex/
- SLSA v1.0 levels: https://slsa.dev/规范/v1.0/levels
