...
- `docs/运营/usage-metering-v1.md`
- `docs/设计/quota-and-budget-policy-v1.md`
- `docs/安全/rate-limit-and-abuse-control-v1.md`
- `docs/生态/paid-capability-and-commerce-boundary.md`
- `docs/质量/usage-evidence-v1.md`
