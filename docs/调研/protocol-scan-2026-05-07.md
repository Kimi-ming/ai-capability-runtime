...
- MCP Security Best Practices：https://modelcontextprotocol.io/docs/tutorials/安全/security_best_practices
...
- `docs/产品/strategy.md`
- `docs/产品/use-cases.md`
- `docs/产品/capability-lifecycle.md`
- `docs/设计/domain-model.md`
- `docs/设计/runtime-contracts.md`
- `docs/协议/protocol-positioning.md`
