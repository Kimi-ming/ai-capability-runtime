...
| [Commerce Profile V1 RFC](../rfcs/0020-commerce-profile-v1.md) | 定义 future commerce profile、purchase authorization、billable event 和结算/争议证据边界 | Commerce profile、agentic commerce 或 usage/billing 转换边界变化时 |
...
12. [Commerce Profile V1 RFC](../rfcs/0020-commerce-profile-v1.md)
13. [能力评审清单](社区/capability-review-checklist.md)
