...
| RQ-031 | RFC 治理清晰 | `docs/社区/rfc-process.md`、`rfcs/TEMPLATE.md` | T144 | RFC template；issue template YAML check |
...
| RQ-046 | Secret Resolver 行为稳定 | `docs/设计/secret-resolver-v1.md` | T159, T164 | T159 resolver env/redaction tests；T164 ordering tests |
...
| RQ-060 | Deprecated/yanked/revoked 生命周期清晰 | `docs/生态/capability-deprecation-and-revocation.md` | T186, T188, T191, T192, T193 | revoked invoke gate + registry revocation metadata + lifecycle schema + lifecycle warnings/search tests |
| RQ-061 | Quality Score 不被误用为安全认证 | `docs/质量/capability-quality-score.md` | T194, T195, T196 | quality score rubric + score/policy tests |
