...
下一项 ready：T312 P2：把 release evidence bundle 纳入发布文档。T291 仍是外部 Host UI smoke evidence 限制项。
...
`docs/TASKS.md` 已重新拆成 M0-M6 七个模块化任务队列。T070、T198、T205、T282、T283、T284、T285、T286、T287、T288、T289、T290、T292、T293、T294、T295、T296、T297、T298、T299、T300、T301、T302、T303、T304、T305、T306、T307、T308、T309、T310 和 T311 均已完成；T312 是下一批本地 release evidence ready 任务，剩余 T291 为外部 Host UI smoke evidence 阻塞项。

下一步推荐：执行 T312，或在用户确认本机 Claude Desktop/Cursor Host 环境可用后处理 T291。
