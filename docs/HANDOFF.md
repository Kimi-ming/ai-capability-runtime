...
Next task: T212 P1：记录 tool projection hash/evidence。

推荐第一个任务：

```text
T212：记录 tool projection hash/evidence
```

原因：

-  已完成
...
- T212 将为 tool projection 生成稳定 hash/evidence，供 audit 使用

## 最近验证

项目 conda 环境 `ai-capability-runtime` 已创建并安装依赖。T211 本轮已运行：
...
T100 已完成。当前 conda 环境下 `pnpm build`、`pnpm test`、`pnpm lint`、`pnpm validate` 均通过；T211 后测试统计为 spec 20 个、cli 1 个、runtime 63 个、mcp 10 个。`pnpm validate` 当前覆盖 5 个 registry manifest 和 5 个 registry test。`node:sqlite` ExperimentalWarning 仍是已知环境提示。

## 下一步建议

1. 实现 T212：记录 tool projection hash/evidence。
