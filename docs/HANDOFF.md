...
- T232 将定义 Result Envelope 公共类型导出边界，避免 MCP/CLI adapter 复制类型定义。

## 最近验证

项目 conda 环境 `ai-capability-runtime` 已创建并安装依赖。T231 本轮已运行：
...
1. 实现 T232：Result Envelope public type exports。
