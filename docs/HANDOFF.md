...
- T236 将实现 Data Egress Policy Gate，根据 data classes、provider、target origin、risk 和 destination 判断 allow/ask/deny/redact。

## 最近验证

项目 conda 环境 `ai-capability-runtime` 已创建并安装依赖。T235 本轮已运行：
...
1. 实现 T236：实现 Data Egress Policy Gate。
