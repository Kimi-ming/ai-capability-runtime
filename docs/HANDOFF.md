...
Next task: T210 P1：实现 model-visible metadata lint。

推荐第一个任务：

```text
T210：实现 model-visible metadata lint
```

原因：

-  已完成
...
- T210 将实现 model-visible metadata lint，检测 prompt-surface 注入风险

## 最近验证

项目 conda 环境 `ai-capability-runtime` 已创建并安装依赖。T209 本轮已运行：
...
T100 已完成。当前 conda 环境下 `pnpm build`、`pnpm test`、`pnpm lint`、`pnpm validate` 均通过；T209 后测试统计为 spec 11 个、cli 1 个、runtime 63 个、mcp 10 个。`pnpm validate` 当前覆盖 5 个 registry manifest 和 5 个 registry test。`node:sqlite` ExperimentalWarning 仍是已知环境提示。

## 下一步建议

1. 实现 T210：实现 model-visible metadata lint。
