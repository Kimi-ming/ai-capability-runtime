...
Next task: T211 P1：补充 prompt-surface negative fixtures。

推荐第一个任务：

```text
T211：补充 prompt-surface negative fixtures
```

原因：

-  已完成
...
- T211 将把 prompt-surface 注入风险转成可复用 negative fixtures

## 最近验证

项目 conda 环境 `ai-capability-runtime` 已创建并安装依赖。T210 本轮已运行：
...
T100 已完成。当前 conda 环境下 `pnpm build`、`pnpm test`、`pnpm lint`、`pnpm validate` 均通过；T210 后测试统计为 spec 16 个、cli 1 个、runtime 63 个、mcp 10 个。`pnpm validate` 当前覆盖 5 个 registry manifest 和 5 个 registry test。`node:sqlite` ExperimentalWarning 仍是已知环境提示。

## 下一步建议

1. 实现 T211：补充 prompt-surface negative fixtures。
