...
Next task: T213 P1：MCP tools/list 使用 Runtime-generated risk summary。

推荐第一个任务：

```text
T213：MCP tools/list 使用 Runtime-generated risk summary
```

原因：

-  已完成
...
- T213 将让 tools/list 的风险摘要来自结构化 permissions/risk summary

## 最近验证

项目 conda 环境 `ai-capability-runtime` 已创建并安装依赖。T212 本轮已运行：
...
T100 已完成。当前 conda 环境下 `pnpm build`、`pnpm test`、`pnpm lint`、`pnpm validate` 均通过；T212 后测试统计为 spec 20 个、cli 1 个、runtime 63 个、mcp 12 个。`pnpm validate` 当前覆盖 5 个 registry manifest 和 5 个 registry test。`node:sqlite` ExperimentalWarning 仍是已知环境提示。

## 下一步建议

1. 实现 T213：MCP tools/list 使用 Runtime-generated risk summary。
